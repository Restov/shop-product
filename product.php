        ...
        <div class="layout">
            <div class="product">
                ...
                <div class="product__description">
                    <h2 class="product__title"><?php echo $product['title']; ?></h1>
